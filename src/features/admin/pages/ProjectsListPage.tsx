  ...
  return (
    ...
    >
      ...
      <AdminCard className="p-4">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-end">
          <div className="flex-1">
            ...
            <input
              ...
              className="w-full rounded-lg border border-foreground/15 bg-background px-3 py-2 text-sm text-foreground outline-none transition focus:border-border-strong focus:ring-1 focus:ring-focus-ring/35 disabled:cursor-not-allowed disabled:opacity-60"
            />
          </div>
          <AdminButton
        ...
        {importError && (
          <p className="mt-3 rounded-lg border border-status-danger/25 bg-status-danger/10 px-3 py-2 text-sm text-foreground" role="alert">
            {importError}
          </p>
        )}
      </AdminCard>
